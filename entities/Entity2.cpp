...
Entity2::Entity2(SDL_Rect rect, const std::string& id, Sprite* sprite)
    : rect(rect), id(id), sprite(sprite), direction(90), moving(false), speed(8) {}

Entity2::Entity2(SDL_Rect rect, int direction, const std::string& id, Sprite* sprite)
...
void Entity2::update(Level* level) {
...
bool Entity2::isCollidingWithMap(Level* level) {
